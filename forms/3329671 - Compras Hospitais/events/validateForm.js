    ...
    if (isTransferOrSave() == false) {
        ...
        if (CURRENT_STATE == INICIO || CURRENT_STATE == 0) {
            ...
            if (tipoCompra == "1") {
                ...
                campoObrigatorio(form, "expectativaPrecoServ", "Qual a expectativa de preço para essa aquisição. Tem algum orçamento já aprovado");
                campoObrigatorio(form, "visitaServ", "Informe nome, telefone, email e horários disponiveis pararecebimento da visita técnica");
                campoObrigatorio(form, "unidadeContratoServ", "A unidade já possui algum contrato ativo para esse serviço");
            ...
            if (tipoCompra == "2") {
                ...
                campoObrigatorio(form, "expectativaPrecoDiversos", "Qual a expectativa de preço para essa aquisição. Tem algum orçamento já aprovado");
            ...
            if (tipoCompra == "3") {
                ...
                campoObrigatorio(form, "expectativaPrecoTi", "Qual a expectativa de preço para essa aquisição. Tem algum orçamento já aprovado");
            ...
            if (form.getValue("tipoCompra") == '5') {
                ...
                campoObrigatorio(form, "expectativaPreco", "Qual a expectativa de preço para essa aquisição. Tem algum orçamento já aprovado");
            ...
            if (form.getValue("correcaoSolicitacao") != 'true') {
                ...
                if (form.getValue("tipoCotacaoHidden") == "fechada") {
                    ...
                    if (form.getValue('hideFornecedorExclu') == 'false') {
                        if ((valorTotalProd > 1000 && valorTotalProd <= 10000 && indexForn.length < 2) && form.getValue("justificativaAnaliseComprador") == "") {
                            throw "O valor total das Cotações está entre R$1.001 à R$10.000. É necessário justificar o motivo de não ter no mínimo 2 Fornecedores. </br>";
                        }
                        if ((valorTotalProd > 10000 && indexForn.length < 3) && form.getValue("justificativaAnaliseComprador") == "") {
                            throw "O valor total das Cotações é maior que R$10.000. É necessário justificar o motivo de não ter no mínimo 3 Fornecedores. </br>";
                        }
                    }
                }
                ...
                if (form.getValue("hideContratoGuardChuva") == "true" || form.getValue("hideContrato") == "true") {
                    ...
                    campoObrigatorio(form, "validaEmail", "E-mail Comercial");
            ...
            if (form.getValue("decisaoAlcada") == "") {
                errorMsg += "Seleciona uma das opções de <b>Decisão</b> - Aprovar ou Reprovar";
            } else if (form.getValue("decisaoAlcada") == "nao") {
                if (CURRENT_STATE == ALCADA_APROVACAO && form.getValue("sMotivoReprovAlcada") == null) {
                    errorMsg += "Selecione uma das opções para o <b>Motivo</b> da reprovação.</br>";
                }
                if (form.getValue("motivoAprovAlcada") == "") {
        ...
        } else if (CURRENT_STATE == APROVACAO_GESTOR) {
            campoObrigatorio(form, "decisaoGestor", "Aprovar ou reprovar a solicitação");
            if (form.getValue("decisaoGestor") == "nao") {
                campoObrigatorio(form, "motivoReprovGestor", "Motivo da reprovação");
            }
